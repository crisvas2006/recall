...
| **Embeddings**        | `text-embedding-004` @ **768 dims**, task types `RETRIEVAL_DOCUMENT` / `RETRIEVAL_QUERY`    | Google's newest embedding model; native 768-dim truncation keeps vector DB tiny with ~zero quality loss             |
